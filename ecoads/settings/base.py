"""
Django settings for ecoads project.
...
INSTALLED_APPS = [
    ...
    'allauth',
    'allauth.account',
    'allauth.socialaccount', # check for the providers we want to enable
]
...
WSGI_APPLICATION = 'ecoads.wsgi.application'
